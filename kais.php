...
<div class="dropdown-menu" x-placement="right-start" style="position: absolute; transform: translate3d(230px, 0px, 0px); top: 4px; left: 0px; will-change: transform;" >
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown2">
										...
										<a class="dropdown-item" <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Στάσεις με Προεξοχές <i class="fa fa-angle-down" aria-hidden="true"></i></a>
											<div class="dropdown-menu" x-placement="right-start" style="position: absolute; transform: translate3d(230px, 30px, 0px); top: 4px; left: 35px; will-change: transform;" >
                                                <a class="dropdown-item" href="kais.php">Δήμος Αγίας Βαρβάρας</a>
												<a class="dropdown-item" href="kais.php">Δήμος Αγίου Δημήτριου</a>
												<a class="dropdown-item" href="kais.php">Δήμος Αθηνών</a>
												<a class="dropdown-item" href="kais.php">Δήμος Ελληνικού-Αργυρούπολης</a>
												<a class="dropdown-item" href="kais.php">Δήμος Αχαρνών</a>
												<a class="dropdown-item" href="kais.php">Δήμος Βύρωνα</a>
												<a class="dropdown-item" href="kais.php">Δήμος Γλυφάδας</a>
												<a class="dropdown-item" href="kais.php">Δήμος Δάφνης-Υμηττού</a>
												<a class="dropdown-item" href="kais.php">Δήμος Ζωγράφου</a>
												<a class="dropdown-item" href="kais.php">Δήμος Ηλιούπολης</a>
												<a class="dropdown-item" href="kais.php">Δήμος Καισαριανής</a>
												<a class="dropdown-item" href="kais.php">Δήμος Καλλιθέας</a>
												<a class="dropdown-item" href="kais.php">Δήμος Μελλισίων</a>
												<a class="dropdown-item" href="kais.php">Δήμος Νέας Σμύρνης</a>
												<a class="dropdown-item" href="kais.php">Δήμος Νέας Χαλκηδόνας-Νέας Φιλαδέφλιας</a>
												<a class="dropdown-item" href="kais.php">Δήμος Νίκαιας</a>
												<a class="dropdown-item" href="kais.php">Δήμος Παπάγου-Χολαργού</a>
												<a class="dropdown-item" href="kais.php">Δήμος Παλαιού Φαλήρου</a>
												<a class="dropdown-item" href="kais.php">Δήμος Πειραιά</a>
												<a class="dropdown-item" href="kais.php">Δήμος Περάματος</a>
												<a class="dropdown-item" href="kais.php">Δήμος Περιστερίου</a>
												<a class="dropdown-item" href="kais.php">Δήμος Πετρούπολης</a>
											</div>
	...
	<section class="dorne-welcome-area bg-img" style="background-image: url(img/ss.jpg);">
                    ...
                    <div class="hero-search-form">
                       ...
                       <div class="tab-content1" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab">
								...
								<pre style="color: white;"><?php echo  $row["stash"]; echo "\t"; echo $row["odos"]; echo "\t"; echo $row["dhmos"]. "<br>";?></pre>
								<?php 
								}
