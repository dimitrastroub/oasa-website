                    ...
                    <nav class="h-100 navbar navbar-expand-lg">
                        ...
                        <!--login-->
								<div id="id01" class="modal1">
								  ...
								  <form class="modal1-content animate" method="post" action="Δικαιολογητικά-Έκδοσης-Εισιτηρίων.php">
  ...
  if(myInput.value.length >= 8) {
    ...
    length.classList.add("invalid");
 	    ...
 	    <section class="dorne-editors-pick-area bg-img bg-overlay-9 section-padding-100" style="background-image: url(img/buy_ticket.jpg);">
            ...
            <div class="row h-100 align-items-center justify-content-center" style="margin-top: 40px">
                <div class="col-12 col-md-10">
                    ...
                    <div class="hero-search-form">
                        ...
                        <div class="tab-content" id="nav-tabContent">
							...
							<h2 style="text-align: justify;"> Απαραίτητα δικαιολογητικά που πρέπει να προσκομιστούν στο εκδοτήριο για την απόκτηση προσωποποιημένης Ath.ena Card είναι:</h2>
							<br>
							<h2 style="text-align: justify;"> α) Για Έλληνες πολίτες:
								<br>
								Αστυνομική ταυτότητα (για παιδιά κάτω των 13 επαρκεί το βιβλιάριο υγείας) <br>
								Έγγραφο βεβαίωσης ΑΜΚΑ (π.χ. βιβλιάριο υγείας, εκτύπωση ή υπόδειξη από κινητό βεβαίωσης από το amka.gr) <br>
								Για δικαιούχους μειωμένου κομίστρου, το αντίστοιχο δικαιολογητικό (π.χ. ακαδημαϊκή ταυτότητα, βιβλιάριο πολυτέκνων κ.λπ.)
								<br><br>
								...
								<h2 style="text-align: justify;">Στα εκδοτήρια δεν είναι απαραίτητη η προσκόμιση τυπωμένης φωτογραφίας.</h2>
								<br>

								<h2 style="text-align: justify;">Επίσης ζητείται από τον κάτοχο να ορίσει 8ψήφιο κωδικό PIN για την κάρτα.</h2>
								<br>

								<h2 style="text-align: justify;">Η έκδοση της κάρτας είναι δωρεάν.</h2>
								<br>
