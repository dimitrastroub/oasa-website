                    ...
                    <nav class="h-100 navbar navbar-expand-lg">
                        ...
                        <!--login-->
								<div id="id01" class="modal1">
								  ...
								  <form class="modal1-content animate" method="post" action="Σημεία-Έκδοσης-Επαναφόρτισης.php">
					...
					<nav class="h-30 navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="dorneNav"  >
                            <ul class="navbar-nav mr-auto" id="dorneMenu">
									...
									<a class="nav-link" href="#"> > </a>
									<a class="nav-link" href="Σημεία-Έκδοσης-Επαναφόρτισης.php"><span style="color:rgba(0, 85, 132,1); font-weight: bold; font-size:18px; ">Σημεία-Έκδοσης-Επαναφόρτισης</span></a>
                    </nav>
                ...
                <div class="col-12 col-md-10">
                    ...
                    <div class="hero-search-form">
                        ...
                        <div class="tab-content" id="nav-tabContent">
							...
							<h2 style="text-align: justify;"> Για να εκδώσετε άμεσα την προσωποποιημένη Ath.ena Card ή να την επαναφορτίσετε μπορείτε να απευθυνθείτε στα παρακάτω εκδοτήρια:</h2>
							<br>
							<h2 style="text-align: justify;"> α) Μετρό & ΗΣΑΠ: Όλα τα ανοικτά εκδοτήρια ΠΛΗΝ Λαρίσης, Ακρόπολης και Αεροδρομίου.
								
								<br><br>
								β) Στάσεις Τραμ: Αγία Φωτεινή
								
								<br>
								<br>

								γ) Εκδοτήρια Λεωφορείων: Αεροδρόμιο – αφίξεις, Οδός Όθωνος (Σύνταγμα)
								<br><br>

								δ) Γραφεία ΟΑΣΑ: Στα γραφεία του ΟΑΣΑ (Μετσόβου 15 Αθήνα) εκδίδονται προσωποποιημένες κάρτες μόνο στην περίπτωση που θέλετε να αγοράσετε εισιτήριο 180 ή 360 ημερών
								<br>
								<br><br>
