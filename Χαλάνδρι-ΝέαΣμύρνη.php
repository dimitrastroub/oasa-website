...
myInput.onkeyup = function() {
  ...
  if(myInput.value.length >= 8) {
	...
	<section class="dorne-editors-pick-area bg-img bg-overlay-9 section-padding-100" style="background-image: url(img/background.jpg);">
		...
		<br><br><br>
		<h2 style=" text-align: center">Σημείο Αναχώρησης: Παλαιολόγου 83, Χαλάνδρι</h2>
                ...
                <div class="col-12 col-md-10">
                    ...
                    <div class="hero-search-form" style="width: 1000px">
                        ...
                        <div class="nav nav-tabs" id="heroTab" role="tablist" >
                            ...
                            <a class="nav-item nav-link active" id="nav-places-tab" data-toggle="tab" href="#nav-places" role="tab" aria-controls="nav-places" aria-selected="true" style="width: 50%">Βέλτιστη Διαδρομή  ( 51 λεπτά )</a>
                            <a class="nav-item nav-link" id="nav-events-tab" data-toggle="tab" href="#nav-events" role="tab" aria-controls="nav-events" aria-selected="false" style="width: 50%">Εναλλακτική Διαδρομη  ( 55 λεπτά )</a>
                        </div>
								  ...
								  <div class="container left">
									<div class="content">
									  <?php
										...
										$sql = "SELECT * FROM ChalandriNeaSmirni2";
										$result = $db->query($sql);
								  ...
								  <div class="container left">
									<div class="content">
									  <?php
										...
										$sql = "SELECT * FROM ChalandriNeaSmirni";
										$result = $db->query($sql);
										while($row = $result->fetch_assoc()) { 
											if($row["id"]==1)
												echo  "Από: &nbsp  " . $row["anaxwrhsh"]."</br></br>" . $row["meso"] ." &nbsp&nbsp" . $row["wra"]. " λεπτά, " . $row["staseis"]. "</br></br> Έως: &nbsp  " . $row["proorismos"] ."</br>" ;
