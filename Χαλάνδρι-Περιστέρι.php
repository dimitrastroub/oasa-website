                    ...
                    <nav class="h-100 navbar navbar-expand-lg">
                        ...
                        <!--login-->
								<div id="id01" class="modal1">
								  ...
								  <form class="modal1-content animate" method="post" action="Χαλάνδρι-Περιστέρι.php">
                ...
                <div class="col-12 col-md-10">
                    ...
                    <div class="hero-search-form" style="width: 1000px">
                        ...
                        <div class="nav nav-tabs" id="heroTab" role="tablist" >
                            ...
                            <a class="nav-item nav-link" id="nav-events-tab" data-toggle="tab" href="#nav-events" role="tab" aria-controls="nav-events" aria-selected="false" style="width: 50%">Εναλλακτική Διαδρομη  ( 53 λεπτά )</a>
                        </div>
								  ...
								  <div class="container left">
									<div class="content1">
									  <?php
										...
										$sql = "SELECT * FROM chalandriperisteri";
										$result = $db->query($sql);
								  ...
								  <div class="container left">
									<div class="content1">
									  <?php
										...
										$sql = "SELECT * FROM chalandriperisteri2";
										$result = $db->query($sql);
										while($row = $result->fetch_assoc()) { 
											if($row["id"]==1)
												echo  "Από: &nbsp  " . $row["anaxwrhsh"]."</br></br>" . $row["meso"] ." &nbsp&nbsp" . $row["wra"]. " λεπτά, " . $row["staseis"]. "</br></br> Έως: &nbsp  " . $row["proorismos"] ."</br>" ;
