                    ...
                    <nav class="h-100 navbar navbar-expand-lg">
                        ...
                        <!--login-->
								<div id="id01" class="modal1">
								  ...
								  <form class="modal1-content animate" method="post" action="ΑΜΕΑ-ΣτάσειςΜεΠροεξοχές-Παπάγος.php">
					...
					<nav class="h-30 navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="dorneNav">
                            <ul class="navbar-nav mr-auto" id="dorneMenu">
									...
									<a class="nav-link" href="#"> > </a>
									<a class="nav-link" href="ΑΜΕΑ-ΣτάσειςΜεΠροεξοχές-Παπάγος.php"><span style="color:rgba(0, 85, 132,1); font-weight: bold; font-size:18px; ">Δήμος Παπάγου-Χολαργού</span></a> 
                    </nav>
                    ...
                    <div class="hero-search-form">
                       ...
                       <div class="tab-content1" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab">
                                <h2><i class="fa fa-map-marker" aria-hidden="true"> </i> <i style =" font-style:normal;" >Στάση  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </i> <i  style =" font-style:normal;" >Οδός &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp </i> <i  style =" font-style:normal;" >Δήμος &nbsp &nbsp &nbsp &nbsp &nbsp </i> <br><br>
								<?php
								$db=mysqli_connect('localhost','root','','sdi1600021');
