                    ...
                    <nav class="h-100 navbar navbar-expand-lg">
                        ...
                        <!--login-->
								<div id="id01" class="modal1">
								  ...
								  <form class="modal1-content animate" method="post" action="Χαλάνδρι-Περιστέρι-Νυχτερινό.php">
                ...
                <div class="col-12 col-md-10">
                    ...
                    <div class="hero-search-form" style="width: 1000px">
                        ...
                        <div class="nav nav-tabs" id="heroTab" role="tablist" >
                            ...
                            <a class="nav-item nav-link active" id="nav-places-tab" data-toggle="tab" href="#nav-places" role="tab" aria-controls="nav-places" aria-selected="true" style="width: 100%">Βέλτιστη Διαδρομή  ( 1 ώρα και 57 λεπτά )</a>
                        </div>
								  ...
								  <div class="container left">
									<div class="content1">
									  <?php
										...
										$sql = "SELECT * FROM chalandriperisteri3";
										$result = $db->query($sql);
